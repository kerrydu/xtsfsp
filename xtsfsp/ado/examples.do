* translog, graph2tex, tictoc should be installed in advance
capture log close
set  varabbrev off 
clear 
sjlog using xtsfsp_DGP1, replace
use xtsfsp_ex1.dta
xtset id t 
...
clear 
sjlog using xtsfsp_DGP2, replace
...
sjlog using xtsfsp_DGP2a, replace
...
sjlog using xtsfsp_DGP2b, replace
...
clear 
sjlog using xtsfsp_DGP3, replace
...
capture log close
clear all
sjlog using xtsfsp_ex4, replace
