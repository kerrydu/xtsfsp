...
* Case7: y=x+v-u; v=[I-tauW]^{-1}v*
capture program drop xtsfspv
...
************
   ...
   * generating Wx
	...
	ml model d0 xtsfspv() (frontier:`yvar' = `xvars' `wxvars2',`noconstant') ///
	                         `vterm'   (uhet: `uhet')  ///
	                         (Wv:), nopreserve `cns' `mlmodelopt' title(`title')
